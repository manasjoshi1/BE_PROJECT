...
#    generatePHN(MLFfile, dstDir)
    srcDir = "D:/BE_PROJECT/Lipreading-Using-Mutimodal-Speech-Recognition-master/TCDTIMITDataset"
    dstDir = os.path.expanduser("D:/BE_PROJECT/Lipreading-Using-Mutimodal-Speech-Recognition-master/TCDTIMIT/audio")
