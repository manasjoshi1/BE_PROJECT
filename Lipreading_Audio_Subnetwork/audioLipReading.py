...
if __name__ == '__main__':
    ...
    dataset_train = collect_audio_files('D:/BE_PROJECT/Lipreading-Using-Mutimodal-Speech-Recognition-master/TCDTIMIT/audio/lipspeakers')
    ...
    model.fit(X_train, y_train, epochs=10,validation_data=(X_val, y_val), callbacks=callbacks_list)
